...
# system parameters
system_name = "sgrAstar"
simulation_duration = 100. # in years
...
pl.ylabel(r"Total Energy [$\times 10^{50}$ ergs]", labelpad=10)
pl.xlabel("Time [years]", labelpad=15)
pl.plot(np.array(times) / seconds_per_year, np.array(energies) / 1e50, lw=8)
