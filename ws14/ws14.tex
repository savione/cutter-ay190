...
I worked with no one on this worksheet. It took about one hour.

\subsection{Advection Equation}

I modified \texttt{upwind.py} from WS11 to have variable velocity based on the value of the function; i.e. Burger's equation rather than the advection equation. When the initial data is a sine wave, a beautiful shock forms by \(t = 150\) as the two peaks run into each other, as shown in the figures below.

\begin{figure}[H]
 \centering
 \hspace{0cm} \includegraphics[width=0.6\textwidth]{fig_t-0.pdf}
...
\begin{figure}[H]
 \centering
 \hspace{0cm} \includegraphics[width=0.6\textwidth]{fig_t-50.pdf}
 \caption{Solution to Burger's equation at time \(t = 50\).}
 \label{fig_t-50}
\end{figure} 

\begin{figure}[H]
 \centering
 \hspace{0cm} \includegraphics[width=0.6\textwidth]{fig_t-100.pdf}
 \caption{Solution to Burger's equation at time \(t = 100\).}
 \label{fig_t-100}
\end{figure} 

\begin{figure}[H]
 \centering
 \hspace{0cm} \includegraphics[width=0.6\textwidth]{fig_t-150.pdf}
 \caption{Solution to Burger's equation at time \(t = 150\). At this point, the shock discontinuity is beginning to form.}
 \label{fig_t-150}
\end{figure} 

\begin{figure}[H]
 \centering
 \hspace{0cm} \includegraphics[width=0.6\textwidth]{fig_t-200.pdf}
 \caption{Solution to Burger's equation at time \(t = 200\).}
 \label{fig_t-200}
\end{figure} 
